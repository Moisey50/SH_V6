// Code39Reader.cpp : implementation file
//
...
void CCode39Event(int Event, void *Data, void *pParam, CDIBViewBase* wParam)
{
    CCode39Reader* pv=(CCode39Reader*)pParam;
...
CCode39Reader::CCode39Reader(CWnd* pParent /*=NULL*/)
		: CDispDlg(CCode39Reader::IDD, pParent),
		  m_ResultStr(_T(""))
{
    m_Frame.lpBMIH=NULL;	
    m_Frame.lpData=NULL;
	//{{AFX_DATA_INIT(CCode39Reader)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}

void CCode39Reader::DoDataExchange(CDataExchange* pDX)
{
	CDispDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCode39Reader)
...
BEGIN_MESSAGE_MAP(CCode39Reader, CDispDlg)
	//{{AFX_MSG_MAP(CCode39Reader)
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_RUN_TVDB, CCode39Reader::OnBnClickedRunTvdb)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CCode39Reader message handlers

BOOL CCode39Reader::OnInitDialog() 
{
    ...
    m_Display.SetCallback(CCode39Event,this);
	return TRUE;  // return TRUE unless you set the focus to a control
	              // EXCEPTION: OCX Property Pages should return FALSE
}

void CCode39Reader::OnDestroy() 
{
	if (m_Frame.lpBMIH) free(m_Frame.lpBMIH); m_Frame.lpBMIH=NULL;
	CDispDlg::OnDestroy();
}

bool CCode39Reader::LoadDIB(BITMAPINFOHEADER *bmih)
{
...
void CCode39Reader::OnLineSelection(CPoint& lu, CPoint& rb)
{
    TRACE("+++ (%d:%d) - (%d:%d)\n",lu.x,lu.y, rb.x, rb.y);
...
void CCode39Reader::OnBnClickedRunTvdb()
{
    STARTUPINFO si;
