::**********************************************
::Name:    Full Auto Clean Solutions for SH Only
...
::YouTube:
::Description: Automaticaly cleans all 
::             solutions for all Platforms for 
::             Release and Debug
::**********************************************
@::!/dos/rocks
@ECHO OFF
 ...
 set Compiler="%ProgramFiles(x86)%\Microsoft Visual Studio\2017\Community\Common7\IDE\devenv.com"
 ...
 set Configuration[0]=Release
 set Configuration[1]=Debug
 ...
 setlocal
	...
	call set SlnName=%%SolutionName[%idx%]%%
		...
		if "%idx%"=="3" ( call :fnc_PerformPlatforms %Cmd%,%SlnName%,%%ProjectName[0]%% & call :fnc_PerformPlatforms %Cmd%,%SlnName%,%%ProjectName[1]%% & call :fnc_PerformPlatforms %Cmd%,%SlnName%,%%ProjectName[2]%%)
