// AVT_Vimba.h: interface for the AVT_Vimba class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_AVT_Vimba_H__0C071980_0F39_40DC_A144_B6BEDB69E5DC__INCLUDED_)
#define AFX_AVT_Vimba_H__0C071980_0F39_40DC_A144_B6BEDB69E5DC__INCLUDED_
...
#define  AVT_EVT_SHUTDOWN  0x100
#define  AVT_EVT_START_GRAB 0x200
#define  AVT_EVT_STOP_GRAB  0x400
#define  AVT_EVT_RELEASE    0x800
#define  AVT_EVT_RESTART    0x1000
#define  AVT_EVT_INIT       0x2000
#define  AVT_EVT_LOCAL_STOP  0x4000
#define  AVT_EVT_LOCAL_START 0x8000
#define  AVT_EVT_SET_PROP    0x10000
#define  AVT_EVT_DRIVER_INIT 0x20000
#define  AVT_EVT_BUILD_PROP  0x40000
#define  AVT_EVT_GET_PROP    0x80000
#define  AVT_EVT_LOG         0x100000
#define  AVT_EVT_SET_SOFT_TRIGGER 0x200000
...
typedef struct tagCamProperty
{
  ...
  VmbFeatureInfo_t *  pInfo ;
  bool                m_bStopAcquisition ;
  VmbFeatureDataType  m_DataType ; 
...
class VimbaCamInfo : public CAMERA1394::CameraInfo
{
public:
  AVT::VmbAPI::FeaturePtrVector m_Features ;
  VmbUint32_t                   m_uiNFeatures ;
};
...
public:
  ...
  VmbFeatureInfo_t    m_Info ;
  VmbFeatureDataType  m_Type ;
  FG_PARAMETER        pr;
  bool                m_bIsStopNecessary ;
  ULONG               m_ulRange[2] ;
  double              m_dRange[2] ;
  VmbInt64_t          m_i64Range[2] ;
  VmbInt32_t          m_intVal ;
  VmbBool_t           m_boolVal ;
  VmbUint32_t         m_uintVal ;
  double              m_dVal ;
  VmbInt64_t          m_int64Val ;
  ...
  int GetEnumRangeLength() { return (int)m_EnumRange.GetCount() ; }
};
...
{
public:
  BusyCamera( DWORD dwSN = 0 , AVT_Vimba * pGadget = NULL ) 
  {
...
class AVT_Vimba : public C1394Camera  
{
  friend BOOL __stdcall FrameDoneCB(const AVT::VmbAPI::FramePtr pFrame , void * pClient )  ;  
  friend CVideoFrame * ConvertAVTtoSHformat( 
...
public:  
  ...
  VmbInt64_t          GetWidth() { return m_nWidth; }
  VmbInt64_t          GetHeight() { return m_nHeight; }
  ...
  void SaveCameraInfo( const AVT::VmbAPI::CameraPtr &camera , int iIndex ) ;
...
private:
  ...
  VmbInt64_t m_nSensorWidth ;
  VmbInt64_t m_nSensorHeight ;
  CamProperties           m_PropertiesEx ;
  const CamProperty *     m_pOrigProperties ;
  int                     m_iNProperties ;
private:
  static FXLockObject           m_ConfigLock ;
  static VimbaCamInfo           m_CamInfo[MAX_CAMERASNMB] ;
  ...
  VmbInterfaceInfo_t  m_IntfType ;
  DWORD               m_BusEvents ;
  VmbErrorType        m_LastError;
  enum CameraStatus
  {
    NotInitialized = 0 ,
    CantGetCameras ,
...
//   Mode		    m_Mode;
  ...
  VmbPixelFormat_t m_pixelFormat; // necessary pixel format
  UINT        m_uiPacketSize ;
  CSize       m_SensorSize ;
  float       m_fPercentage ;
  int         m_iFPSx10 ;
...
public:
  ...
  virtual bool IsTriggerByInputPin() 
  {
    if (m_bVimbaSoftTrigger)
      return false;
  ...
  */
  ...
  DECLARE_RUNTIME_GADGET(AVT_Vimba);
private:
  ...
  bool AVTCameraStart();
  void AVTCameraStop() ;
  bool AVTBuildPropertyList();
  bool AVTSaveOrLoadSettings( int iMode ) ; // 0 - nothing to do, 1 - Save, 2 - Load
  bool AVTSetSoftwareTriggerMode( bool bSet ) ;
  bool AVTSetCameraPropertyEx( LPCTSTR pName , SetCamPropertyData * pData );
  bool AVTGetCameraPropertyEx( LPCTSTR pName , SetCamPropertyData * pData );
...
protected:
  void GetCamResolutionAndPixelFormat(unsigned int* rows,
    unsigned int* cols, VmbPixelFormatType* pixelFmt); //
  unsigned int GetBppFromPixelFormat( VmbPixelFormat_t pixelFormat );                           //

  bool GetULongFeature( AVT::VmbAPI::CameraPtr& CameraPtr ,
    LPCTSTR pFeatureName , VmbUint32_t& ulValue ) ;
  bool SetULongFeature( AVT::VmbAPI::CameraPtr& CameraPtr ,
    LPCTSTR pFeatureName , VmbUint32_t ulValue ) ;
  bool GetPropertyValue( AVT::VmbAPI::CameraPtr& pCam , 
    LPCTSTR Name , SetCamPropertyData& Value ) ;
  bool SetPropertyValue( AVT::VmbAPI::CameraPtr& pCam , 
    LPCTSTR Name , SetCamPropertyData& Value ) ;
  bool SetPropertyValue( LPCTSTR Name , SetCamPropertyData& Value ) ;
  VmbErrorType GetFeatureIntValue( const AVT::VmbAPI::CameraPtr &camera ,
    LPCTSTR pFeatureName, VmbInt64_t & value ) ;
  VmbErrorType AVT_Vimba::SetFeatureIntValue( 
    const AVT::VmbAPI::CameraPtr &camera, 
    LPCTSTR pFeatureName , VmbInt64_t value ) ;
  bool RunCameraCommand( LPCTSTR pCommand ) ;

  VmbUint32_t GetXSize(AVT::VmbAPI::CameraPtr& CameraPtr)  ;
  void SetWidth( AVT::VmbAPI::CameraPtr& CameraPtr , VmbUint32_t Width ) ;
  VmbUint32_t GetYSize( AVT::VmbAPI::CameraPtr& CameraPtr ) ;
  void SetHeight( AVT::VmbAPI::CameraPtr& CameraPtr , VmbUint32_t Height ) ;
  VmbUint32_t GetXOffset( AVT::VmbAPI::CameraPtr& CameraPtr ) ;
  void SetXOffset( AVT::VmbAPI::CameraPtr& CameraPtr , VmbUint32_t XOffset ) ;
  VmbUint32_t GetYOffset( AVT::VmbAPI::CameraPtr& CameraPtr ) ;
  void SetYOffset( AVT::VmbAPI::CameraPtr& CameraPtr , VmbUint32_t YOffset ) ;
  VmbUint32_t GetMaxWidth( AVT::VmbAPI::CameraPtr& CameraPtr ) ;
  VmbUint32_t GetMaxHeight( AVT::VmbAPI::CameraPtr& CameraPtr ) ;
...
public:
  ...
  int GetColorMode()
  {
    ...
    if ( m_pixelFormat == VmbPixelFormatBayerGR8
      || m_pixelFormat == VmbPixelFormatBayerRG8
      || m_pixelFormat == VmbPixelFormatBayerGR16
      || m_pixelFormat == VmbPixelFormatBayerGR12
      || m_pixelFormat == VmbPixelFormatBayerGR10
      || m_pixelFormat == VmbPixelFormatBayerRG16
      || m_pixelFormat == VmbPixelFormatBayerRG12 )
      return COLOR_BY_SOFTWARE ; // colors by program
    if ( m_pixelFormat == VmbPixelFormatYuv411
      || m_pixelFormat == VmbPixelFormatYuv422
...
//      || m_pixelFormat == PIXEL_FORMAT_BGR16
  ...
  inline bool CheckAndStopCapture()
  {
    ...
    if ( bWasRunning )
    {
      bool bRes =CamCNTLDoAndWait( AVT_EVT_STOP_GRAB , 1000) ;
      Sleep(100) ;
      m_bWasStopped = true ; 
    }
    return bWasRunning ;
  }
  bool OtherThreadDriverInit() { return CamCNTLDoAndWait( AVT_EVT_DRIVER_INIT , 5000) ; }
  bool OtherThreadCameraInit() { return CamCNTLDoAndWait( AVT_EVT_INIT ) ; }
  bool OtherThreadBuildPropertyList() { return CamCNTLDoAndWait( AVT_EVT_BUILD_PROP , 10000 ) ; }
  bool OtherThreadCameraClose() { return CamCNTLDoAndWait( AVT_EVT_RELEASE ) ; }
  bool OtherThreadCameraStart() { return CamCNTLDoAndWait( AVT_EVT_START_GRAB ) ; }
  bool OtherThreadCameraStop() { return CamCNTLDoAndWait( AVT_EVT_STOP_GRAB , 5000) ; }
  bool OtherThreadCameraShutDown() { return CamCNTLDoAndWait( AVT_EVT_SHUTDOWN ) ; }
  bool OtherThreadLocalStart() { return CamCNTLDoAndWait( AVT_EVT_LOCAL_START ) ; }
  bool OtherThreadLocalStop() { return CamCNTLDoAndWait( AVT_EVT_LOCAL_STOP ) ; }
  bool OtherThreadSetProperty( int iIndex , SetCamPropertyData * pData , bool * bInvalidate )
  {
    ...
    m_bInvalidate = false ;
    bool bRes = CamCNTLDoAndWait( AVT_EVT_SET_PROP ) ;
    if ( bRes )
    {
    ...
    TCHAR * pName = NULL  )
  {
    ...
    m_bInvalidate = false ;
    bool bRes = CamCNTLDoAndWait( AVT_EVT_GET_PROP ) ;
  ...
  bool OtherThreadSetSoftwareTrigger( bool bSet )
  {
    ...
    bool bRes = CamCNTLDoAndWait( AVT_EVT_SET_SOFT_TRIGGER ) ;
    return bRes ;
  }
  ...
  FXString DecodeEvtMask( DWORD dwEVtMask )
  {
    ...
    if ( dwEVtMask & AVT_EVT_SHUTDOWN )
      Answer += "ShutDown " ;
    if ( dwEVtMask & AVT_EVT_DRIVER_INIT )
      Answer += "DrvInit " ;
    if ( dwEVtMask & AVT_EVT_RELEASE )
      Answer += "Release " ;
    if ( dwEVtMask & AVT_EVT_RESTART )
      Answer += "Restart " ;
    if ( dwEVtMask & AVT_EVT_INIT )
      Answer += "CamInit " ;
    if ( dwEVtMask & AVT_EVT_START_GRAB )
      Answer += "Start " ;
    if ( dwEVtMask & AVT_EVT_STOP_GRAB )
      Answer += "Stop " ;
    if ( dwEVtMask & AVT_EVT_SET_PROP )
      Answer += "SetProp " ;
    if ( dwEVtMask & AVT_EVT_GET_PROP )
      Answer += "GetProp " ;
    if ( dwEVtMask & AVT_EVT_BUILD_PROP )
      Answer += "BuildProp " ;
    if ( dwEVtMask & AVT_EVT_LOCAL_START )
      Answer += "LocStart " ;
    if ( dwEVtMask & AVT_EVT_LOCAL_STOP )
      Answer += "LocStop " ;
    return Answer ;
  }
...
#endif // !defined(AFX_AVT_Vimba_H__0C071980_0F39_40DC_A144_B6BEDB69E5DC__INCLUDED_)
