// Unibrain.cpp : Defines the initialization routines for the DLL.
//
...
static AFX_EXTENSION_MODULE UnibrainDll = { NULL, NULL };
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	{
		TRACE0("Unibrain.DLL Initializing!\n");
		
		// Extension DLL one-time initialization
		if (!AfxInitExtensionModule(UnibrainDll, hInstance))
			return 0;
