...
#include "R2.h"
#include "Math/nsPolyline.h"

#include <algorithm>

using namespace ns;

double R2::DistanceToRectangle(const ns::Rectangle& rect) const
{
...
double R2::DistanceToPolyline(const ns::Polyline& pl, R2& minP) const
{
...
double R2::dot(const ns::R2& b) const
{
    return x * b.x + y * b.y;
}
...
ns::Rectangle Rectangle::BoundRectangle(const Rectangle& a, const Rectangle& b)
{
    Rectangle ret;
...
ns::Rectangle Rectangle::BoundRectangle(const Rectangle& a, const R2& r)
{
    Rectangle ret;
