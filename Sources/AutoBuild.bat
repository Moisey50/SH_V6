...
::Revisions History
::
::Rev.002 Date: 29/09/2020 Cause: Fixed for folder
::                                with spaces.
::Rev.003 Date: 28/10/2023 Cause: UI_Nview project
::          added to Utilities by MOisey Bernstein
::Rev.004 Date: 14/01/2024 Cause: SH_ShMemStaticLibInterface project
::          added to Utilities by MOisey Bernstein
:: .......................
::**********************************************
@::!/dos/rocks
